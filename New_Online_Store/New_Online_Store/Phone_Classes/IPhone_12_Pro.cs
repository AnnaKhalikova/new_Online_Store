...
{
    public class IPhone_12_Pro : Phone, IPhoneTypeFeatures
    {
        ...
        public IPhone_12_Pro(int iD, string model, int memory, DeviceColor color, double price, string phoneVendorCode)
